<div class="col-md-12">
<input id="width" type="hidden" value="200" />
<input id="height" type="hidden" value="200"/>
<input id="file" type="file" class="form-control btn-success"/>
<br /><span id="message"></span><br />
Gambar :<br>
<div id="img"></div>
<input type="hidden" id="gambar" class="form-control"  name="" value=""></input>
</div>

<script type="text/javascript" src="<?=base_url("assets/gambar/resample.js")?>"></script>
